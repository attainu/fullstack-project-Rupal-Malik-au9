...
export default function Sport() {
  ...
  const likePost = (id) => {
    fetch("http://localhost:2000/likesport", {
      method: "put",
      headers: {
  ...
  const unLikePost = (id) => {
    fetch("http://localhost:2000/unlikesport", {
      method: "put",
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + localStorage.getItem("token"),
  ...
  const commentHandler = (text, postId) => {
    fetch("http://localhost:2000/commentsport", {
      method: "put",
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + localStorage.getItem("token"),
  ...
  const deleteHandler = (postId) => {
    fetch(`http://localhost:2000/deletepostsport/${postId}`, {
      method: "delete",
      headers: {
        Authorization: "Bearer " + localStorage.getItem("token"),
      },
      ...
      <section style={{ width: "80%", margin: "1rem auto" }}>
        ...
        >
          {data ? (
            ...
            <img
              src="https://i.pinimg.com/originals/30/8a/ae/308aae03d136948294661f967b7c0323.gif"
              className="card-img-top"
              alt="loading"
            />
          )}
